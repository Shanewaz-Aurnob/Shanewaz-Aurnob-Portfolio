            ...
            <div className="space-y-4">
              {certificatesData.map((cert, i) => (
                <motion.div
                  ...
                  className="p-6 rounded-2xl border border-white/5 bg-white/[0.01] flex gap-4 items-start cursor-pointer hover:bg-white/[0.04] transition-all group relative overflow-hidden"
                >
                  <div className="p-3 rounded-xl bg-primary/10 text-primary group-hover:bg-primary group-hover:text-dark transition-all shrink-0">
                    <cert.icon size={20} />
                  </div>
                  <div>
